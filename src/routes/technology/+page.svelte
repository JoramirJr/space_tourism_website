...
<div class="w-screen h-screen bg-technology-mobile bg-cover flex flex-col justify-start text-white box-border sm:bg-technology-desktop sm:flex-row-reverse sm:items-center sm:justify-between sm:pt-[20vh]" >
   <div class="mt-[10vh]" >
    <h5 class="font-Barlow-Condensed-Regular text-[18px] tracking-[3px] text-center sm:absolute sm:left-[80px] sm:top-[160px] sm:tracking-[5px] sm:text-[22px]" ><span class="text-gray-600">03 </span>SPACE LAUNCH 101</h5>
   </div>
   <div class={clsx("w-screen h-[25vh] bg-cover my-[30px] sm:w-[55vw] sm:h-[65vh]", {
   ...
   <div class="sm:flex sm:justify-between sm:w-full sm:pl-[7vw] sm:h-[50vh] sm:pt-[8vh]">
      <div class="flex justify-center font-Bellefair-Regular *:gap-[5px] *:h-[40px] *:w-[40px] *:rounded-full *:mx-[10px] *:my-[5px] sm:flex-col sm:gap-[10px] sm:*:h-[50px] sm:*:w-[50px] sm:justify-start" >
         <button 
            class={clsx({ 
      ...
      <div class="sm:mx-[5vw] " >
         <h5 class="font-Barlow-Condensed-Regular text-[16px] tracking-[3px] text-center mt-[20px] sm:text-start" >THE TERMINOLOGY...</h5>
         <h3 class="my-auto font-Bellefair-Regular text-[25px] text-center sm:text-[40px] sm:text-start" >
            {tech_name}
         </h3>
         <h4 class="font-Barlow-Condensed-Regular mt-[10px] font-extralight text-[16px] text-center px-default-mobile sm:text-start sm:px-0" >
            {tech_description}
         </h4>
      </div>
   </div>
