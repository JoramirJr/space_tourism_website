<script>
   ...
   <div class="w-screen h-screen bg-crew-mobile bg-cover flex flex-col justify-start text-white p-default-desktop box-border sm:bg-crew-desktop sm:flex sm:flex-row-reverse sm:justify-between" >
      <div class="mt-[10vh] flex flex-col justify-end items-center md:max-h-[80vh]" >
      <h5 class="font-Barlow-Condensed-Regular text-[18px] tracking-[3px] text-center sm:absolute sm:left-[80px] sm:top-[160px] sm:tracking-[5px] sm:text-[22px]" ><span class="text-gray-600">02</span> MEET YOUR CREW</h5>
      <div class="max-h-[40vh] w-[40vw] flex flex-col justify-end items-center md:h-[80vh] md:w-[360px] md:fixed md:bottom-0 md:right-[80px]" >
         <img class="mx-auto mt-[30px] aspect-auto " src={member_src_img} alt="Crew member image, mobile" >
      </div>
      <hr class="border-[1px] m-0 border-white sm:hidden" >
      </div>
      <div class="sm:flex sm:flex-col-reverse sm:gap-[40px] sm:ml-[40px] sm:mb-[20px] sm:max-w-[40vw] " >
         <div class="flex justify-center font-Barlow-Condensed-Regular *:gap-[5px] *:h-[10px] *:w-[10px] *:rounded-full *:mx-[10px] *:my-[30px] sm:justify-start" >
            <button 
               class={clsx({ 
         ...
         <div>
         <div class="grid place-items-center text-center sm:text3-left sm:block" >
               <div class="gap-[10px]" >
                  <h4 class="font-Bellefair-Regular tracking-[1px] text-gray-600 text-[18px] " >
                     {member_role}
                  </h4>
                  <h3 class="font-Bellefair-Regular text-[32px] sm:text-[36px]" >
                     {member_name}
                  </h3>
               </div>
               <div >
